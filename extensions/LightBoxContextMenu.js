...
(function(window) {
    ...
    */
    ...
    var cxMenuButtons = [{
        ...
        isVisible: function(diagram) {
            return diagram.commandHandler.canCopySelection();
        }
    }, {
        text: 'Cut',
        command: function(diagram) {
        ...
        isVisible: function(diagram) {
            return diagram.commandHandler.canCutSelection();
        }
    }, {
        text: 'Delete',
        command: function(diagram) {
        ...
        isVisible: function(diagram) {
            return diagram.commandHandler.canDeleteSelection();
        }
    }, {
        text: 'Paste',
        command: function(diagram) {
        ...
        isVisible: function(diagram) {
            return diagram.commandHandler.canPasteSelection(diagram.toolManager.contextMenuTool.mouseDownPoint);
        }
    }, {
        text: 'Select All',
        command: function(diagram) {
        ...
        isVisible: function(diagram) {
            return diagram.commandHandler.canSelectAll();
        }
    }, {
        text: 'Undo',
        command: function(diagram) {
        ...
        isVisible: function(diagram) {
            return diagram.commandHandler.canScrollToPart();
        }
    }, {
        text: 'Zoom To Fit',
        command: function(diagram) {
        ...
        isVisible: function(diagram) {
            return diagram.commandHandler.canZoomToFit();
        }
    }, {
        text: 'Reset Zoom',
        command: function(diagram) {
        ...
        isVisible: function(diagram) {
            return diagram.commandHandler.canResetZoom();
        }
    }, {
        ...
        isVisible: function(diagram) {
            return diagram.commandHandler.canGroupSelection();
        }
    }, {
        ...
        isVisible: function(diagram) {
            return diagram.commandHandler.canUngroupSelection();
        }
    }, {
        text: 'Edit Text',
        command: function(diagram) {
        ...
        isVisible: function(diagram) {
            return diagram.commandHandler.canEditTextBlock();
        }
    }];
    ...
    function showContextMenu(obj, diagram, tool) {
        if (firstTime) {
            ...
            cmLight.addEventListener('contextmenu', function(e) {
                e.preventDefault();
                return false;
            }, false);
            cmLight.addEventListener('selectstart', function(e) {
                e.preventDefault();
                return false;
            }, false);
